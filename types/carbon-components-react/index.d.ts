// Type definitions for carbon-components-react 7.55.1
...
export * from './lib/components/SkeletonIcon';
...
export { default as SkeletonIcon } from './lib/components/SkeletonIcon';
